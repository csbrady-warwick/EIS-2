MODULE eis_constants
  ...
  INTEGER, PARAMETER :: c_pt_variable = 1 !< Type variable
  INTEGER, PARAMETER :: c_pt_constant = 2 !< Type constant
  INTEGER, PARAMETER :: c_pt_operator = 3 !< Type operator
  INTEGER, PARAMETER :: c_pt_function = 4 !< Type function
  INTEGER, PARAMETER :: c_pt_parenthesis = 5 !< Type parenthesis
  INTEGER, PARAMETER :: c_pt_separator = 6 !< Type separator
  INTEGER, PARAMETER :: c_pt_character = 7 !< Type character
  !> Type stack variable (stored variable)
  INTEGER, PARAMETER :: c_pt_stored_variable = 8
  INTEGER, PARAMETER :: c_pt_deferred_variable = 9 !< Type deferred variable
  INTEGER, PARAMETER :: c_pt_deferred_function = 10 !< Type deferred function
  INTEGER, PARAMETER :: c_pt_emplaced_variable = 11 !< Type emplaced variable
  INTEGER, PARAMETER :: c_pt_emplaced_function = 12 !< Type emplaced function
  INTEGER, PARAMETER :: c_pt_bad = 1024 !< Block is of bad type (invalid)
  INTEGER, PARAMETER :: c_pt_null = 1025 !< Block is of null (empty) type

  ! Associativity constants
  INTEGER, PARAMETER :: c_assoc_null = 0 !< No associativity specified
  INTEGER, PARAMETER :: c_assoc_a = 1 !< Fully associative operator
  INTEGER, PARAMETER :: c_assoc_la = 2 !< Left associative operator
  INTEGER, PARAMETER :: c_assoc_ra = 3 !< Right associative operator

  INTEGER, PARAMETER :: c_paren_left_bracket = 1 !< Parenthesis is left bracket
